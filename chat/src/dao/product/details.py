...
from src.dao.product.inventory import ProductInventory
from src.dao.product.metadata import ProductMetadata
from src.dao.product.pricing import ProductPricing
