...
from src.dao.components.metadata import ComponentMetadata
from src.dao.components.inventory import ComponentInventory
from src.dao.components.pricing import ComponentPricing
...
class ComponentDetails(StructuredNode):
    ...
    supplier = connection.create_relationship_to('SupplierDetails','HAS_A')